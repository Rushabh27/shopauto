...
public class Bill extends javax.swing.JFrame {
   ...
   ResultSet rs1;
    ...
    public void billno()
 {
     String sql1="SELECT COUNT(*) FROM `bill_details`";
     
     try{
         con=new connect().docon();
    ...
    {
         String query="INSERT INTO `bill_details`(bill_detail_id,`date`,ammount,`customer_name`) VALUES("+jTextField1.getText()+",'"+jTextField8.getText()+"',"+jTextField7.getText()+",'"+jTextField2.getText()+"');";
         Connection con;    
         Statement st;
         try{
              con=new connect().docon();       
           ...
           String q="INSERT INTO `bill`(bill_detail_id,`customer_name`,product_id,`quantity`,`date`,`MRP`,`total price`) VALUES(?,?,?,?,?,?,?);";
           PreparedStatement pst = con.prepareStatement(q);
           for(int i=0;i<rows;i++)
           {
                 String qty = (String)jTable1.getValueAt(i,0);                
                 String product = (String)jTable1.getValueAt(i,1);
                 String mrp = (String)jTable1.getValueAt(i,2);
                 String price = (String)jTable1.getValueAt(i,3);                 
                 String[] tokens = product.split(" ");
                 String productid = tokens[(tokens.length)-1];
...
pst.executeBatch();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String qtyfromdb="0";
        String demo=(String)jComboBox2.getSelectedItem();
        ...
        try{
            ...
            if(rs1.next())
            {
               qtyfromdb =rs1.getString("quantity");
        ...
        if((Integer.parseInt(qtyfromdb) - Integer.parseInt(qty)) < 0)
        {
        ...
        model.addRow(new Object[]{jTextField5.getText(),jTextField3.getText()+" "+tmp,jTextField4.getText(),result});
        getsum();
        // Update query;
         
        String sql1="UPDATE `product` SET `quantity`=`quantity` - '"+jTextField5.getText()+"' WHERE `product_id`='"+tmp+"'";
      //  Connection con;
        Statement st;
        // ResultSet rs1;
        try{
...
public static  String DateFormat = "yyyy-MM-dd";
    ...
    private void jComboBox2PopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jComboBox2PopupMenuWillBecomeInvisible
        ...
        try{
            ...
            if(rs1.next())
            {
                String add=rs1.getString("product_name");
                jTextField3.setText(add);
                String add1=rs1.getString("product_price");
                jTextField4.setText(add1);
            }
        }
        catch(Exception e)
